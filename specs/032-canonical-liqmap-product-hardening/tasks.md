...
- [ ] T011 Make calibration/model-inspection workflows declare `surface=legacy` explicitly
...
- [ ] T019 Ensure Hyperliquid public runs cannot silently degrade to legacy `/liquidations/levels`

## Phase 5: Validation and Documentation

- [ ] T020 Keep canonical-route browser coverage for Binance, Bybit, and Hyperliquid public flows
- [ ] T021 Keep regression coverage for legacy calibration flows after explicit `surface` adoption
