...
def preflight_liqmap_api(
    ...
    return {
        ...
        "effective_surface": normalized_surface,
        "endpoint_path": endpoint_path,
        "serving_provenance": payload.get("serving_provenance"),
        "serving_artifact_model_id": payload.get("serving_artifact_model_id"),
        "serving_artifact_snapshot_ts": payload.get("serving_artifact_snapshot_ts"),
